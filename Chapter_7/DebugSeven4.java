...
public class DebugSeven4
{
    public static void main(String[] args)
    {
        ...
        for(int i = 0; i < stringLength; i++)   // FIX: changed <= to <
        {
            char ch = Character.toLowerCase(aString.charAt(i));   // FIXED syntax
            System.out.print(ch);
        ...
        System.out.println("The number of LETTERS is " + numLetters);  // FIXED quotes
    }
}
